...
sections:
  who_we_are:
    ...
    bentos: 
      - src: ../../assets/images/making-light.jpg
        class: col-span-2 row-span-2 object-cover object-center order-3
        alt: Person working on making lights
      - src: ../../assets/images/hologon-working-up-tree.jpg
        class: col-span-1 row-span-4 object-cover object-center order-2
        alt: Crowd around illuminated fountain
      - src: ../../assets/images/teamphoto.jpg
        class: col-span-2 row-span-2 object-cover object-center order-1
        alt: Team on site
  what_makes_us:
    scroll_speed: 0    
    ...
    bentos: 
      - src: ../../assets/images/do-not-bend-alley.jpg
      ...
      - src: ../../assets/images/cloud-organ-adults.jpg
        class: col-span-2 row-span-2 object-cover object-center order-3
